        ...
        <form class="form-horizontal">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input class="form-control" id="title" value="{{info['title']}}" type="text"></input>
              </div>
            </div>
            <div class="form-group">
              <label for="authors" class="col-lg-2 control-label">Authors</label>
              <div class="col-lg-10">
                <input class="form-control" id="authors" value="{{info['authors']}}" type="text"></input>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input class="form-control" id="affils" value="{{info['affiliations']}}" type="text"></input>
              </div>
            </div>
            <div class="form-group">
              <label for="contact" class="col-lg-2 control-label">Contact</label>
              <div class="col-lg-10">
                <input class="form-control" id="contact" value="{{info['title']}}" type="text"></input>
